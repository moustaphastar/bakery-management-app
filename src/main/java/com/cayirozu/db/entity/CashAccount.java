...
@NamedQueries({
		@NamedQuery(name = "CashAccount.findAll", query = "SELECT a FROM CashAccount a")
})
public class CashAccount implements java.io.Serializable {
	...
	private Set<CashAccountTransaction> cashAccountTransactions = new HashSet<>(0);
	...
	public CashAccount(int id, Merchant merchant, int fiscalYear, BigDecimal totalReceived, BigDecimal totalPaid,
					   ...
					   boolean active, Set<CashAccountTransaction> cashAccountTransactions) {
		this.id = id;
		this.merchant = merchant;
		this.fiscalYear = fiscalYear;
		this.totalReceived = totalReceived;
	...
	public Set<CashAccountTransaction> getCashAccountTransactions() {
		return this.cashAccountTransactions;
	}

	public void setCashAccountTransactions(Set<CashAccountTransaction> cashAccountTransactions) {
		this.cashAccountTransactions = cashAccountTransactions;
	}

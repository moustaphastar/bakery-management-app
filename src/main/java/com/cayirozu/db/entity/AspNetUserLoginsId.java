...
public class AspNetUserLoginsId implements java.io.Serializable {
	...
	private Serializable providerKey;

	public AspNetUserLoginsId() {
	}

	public AspNetUserLoginsId(Serializable loginProvider, Serializable providerKey) {
	...
	public Serializable getProviderKey() {
		return this.providerKey;
	}

	public void setProviderKey(Serializable providerKey) {
		this.providerKey = providerKey;
	}
